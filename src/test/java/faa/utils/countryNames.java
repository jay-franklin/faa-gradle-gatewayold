...
public class countryNames {
	public String getCountry() throws Exception{
		String[] myStringArrayNames = { "Afghanistan", "Albania", "Algeria", "American Samoa", "Andorra", "Angola", "Anguilla",
				...
				"Cyprus", "Czech Republic", "Côte d'Ivoire", "Denmark", "Djibouti", "Dominica", "Dominican Republic",
				...
				"Kazakhstan", "Kenya", "Kiribati", "Korea, Republic of", "Kosovo", "Kuwait", "Kyrgyzstan", 
...
//"United States", 
		...
		int randomIndex = random.nextInt(246);
		String Country = myStringArrayNames[randomIndex];
		return Country;
	}
}