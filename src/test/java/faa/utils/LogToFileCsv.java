...
public class LogToFileCsv {

   private static String logFile = "C:\\Users\\jfrankl6\\Tools\\TestResults\\JayTestResults11.csv";
   private final static DateFormat df = new SimpleDateFormat ("yyyy.MM.dd  hh:mm:ss ");

   private LogToFileCsv() { }
   ...
   public static void write(String file, String msg) {
       try {
           Date now = new Date();
           String currentTime = LogToFileCsv.df.format(now); 
