...
@all_faa @jay_group3 @create_new_account @create_hobbyist_international1_2_3 @create_hobbyist_international2.feature
...
This feature file opens the web browser and logs into the FAA Drone Welcome Page creates a new hobbyist profile 
Scenario: Scenario 2 - Gateway Create hobbyist account - Confirm and Verify the new hobbyist account -- 15 Steps
